...
function Footer() {
  return (
    <section id="footer ">
      <div className=" py-3 pb-2 max-w-7xl mx-auto ">
        <div className="bg-secondary-shaded h-[1px] mb-14 "> </div>
        <div className="flex justify-center ">
          <Image
            ...
            alt="Logo"
          />
          <span className="text-[15px] block mt-3 ml-3">
            <span className="text-[16px] text-white ">©2021 </span>
            <span className="text-primary">Pirasanthan Jesugeevegan</span>
          </span>
        </div>
        <div className="flex justify-center -translate-y-3 mb-12">
          <ul className="">
