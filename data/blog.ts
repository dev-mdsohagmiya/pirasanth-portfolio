export default [
   {
      ...
      "publish":true,
      "likes":8,
      "description":"In this post I'm going to show you how to run Cypress in a Jenkins pipeline (via Docker)....",
      "body":[
         {
            "children":[
               {
   ...
   },
   {
      ...
      "description":"We will be discussing a topic that has been talked about when it comes to E2E testing.  It's vital t...",
      "publish":true,
      "text":"2 min read",
      "minutes":1.25,
      "time":75000,
   ...
   },
   {
      ...
      "description":"Testing sites are always a must, even for courses, workshops, webinars, testing new tools, and more....",
      "likes":4,
      "author":{
         "name":"PJ",
         "image":{
   ...
   },
   {
      ...
      "description":"In this article, we will be talking about docker (build, tag & push) to AWS ECR and how we can use it to speed up automation test runs.",
      ...
      "slug":{
         "current":"how-to-build-and-push-docker-images-to-aws-ecr-with-github-action",
         "_type":"slug"
      },
      "body":[
         {
   ...
   },
   {
      ...
      "comments":[
         ...
         },
         {
            ...
            "_type":"comment",
            "comment":"Please remove the music. It is hard to hear your voice with the background music. Maybe you could play the music and the beginning and the end instead?\nThanks for the demo!"
         }
      ],
      "categories":[
         {
      ...
      "description":"In this article, I will be showing how to Integrate ChatGPT into Cypress and generate test scripts a...",
   ...
   },
   {
      ...
      "likes":12,
      "description":"Till now, we have written all the Cypress test scripts directly in the JavaScript files, but with th...",
      "slug":{
   ...
   {
      "description":"We are going to go through NVM - Node Version Manager and how to setup via Homebrew...",
   ...
   },
   {
      ...
      "description":"In this article, we will learn how to use Jenkins Pipeline plugin to notify Microsoft Teams channel ...",
      "text":"2 min read",
      "minutes":1.265,
      "time":75900,
      "words":253
   },
   {
      ...
      "description":"As not long ago we were introduced to Cypress v10 with breaking changes. The process of installation of cypress is quite simple and easy but we’ll look at how to install and configure cucumber with it.",
   ...
   },
   {
      ...
      "slug":{
         "current":"top-visual-studio-code-extensions-for-automation-engineers-in-2022",
         "_type":"slug"
      },
      "author":{
         "image":{
      ...
      "description":"Top 10 Visual Studio Code extensions for Automation Engineers",
      "comments":[
         {
            "approved":true,
            "post":{
   ...
   },
   {
      ...
      "description":"Cypress is a fast, easy and reliable testing tool for anything that runs in a browser. It’s becoming...",
      "text":"2 min read",
      "minutes":1.24,
      "time":74400,
      "words":248
